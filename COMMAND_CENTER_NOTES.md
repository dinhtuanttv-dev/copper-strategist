...
# Nếu Vercel KV tự tạo biến KV_REST_API_URL/TOKEN thì dùng bộ đó thay thế.
# KV_REST_API_URL=...
# KV_REST_API_TOKEN=...
TRADINGECONOMICS_API_KEY=<client:secret của TradingEconomics, nếu dùng LME provider>
